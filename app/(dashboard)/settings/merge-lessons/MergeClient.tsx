  ...
  if (result) {
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-6">
        <h3 className="font-semibold text-green-800 mb-2">統合完了</h3>
        <p className="text-sm text-green-700">{result.mergedLessons}件のコマを削除・統合しました</p>
        <p className="text-sm text-green-700">{result.movedEnrollments}件の生徒割り当てを移動しました</p>
        <p className="text-xs text-green-600 mt-3">スケジュール画面を確認してください</p>
      </div>
    )
  }
    ...
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 rounded-xl overflow-hidden">
        <div className="bg-gray-50 px-4 py-2.5 border-b border-gray-200 flex justify-between items-center">
          <span className="text-sm font-semibold text-gray-700">統合対象一覧</span>
